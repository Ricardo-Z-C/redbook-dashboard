...
async def parse_cmd(argv: Optional[Sequence[str]] = None):
    ...
    def main(
        ...
        account_name: Annotated[
            ...
            typer.Option(
                "--account-name",
                help="Account name used for tracking stats",
                rich_help_panel="Account Configuration",
            ),
        ] = config.ACCOUNT_NAME,
        dashboard_user: Annotated[
            str,
            typer.Option(
                "--dashboard-user",
                help="Dashboard user who initiated the crawl",
                rich_help_panel="Account Configuration",
            ),
        ...
        sort_type: Annotated[
            ...
            typer.Option(
                "--sort-type",
                help="Search sort type (general=General | popularity_descending=Most Popular | time_descending=Latest)",
                rich_help_panel="Basic Configuration",
            ),
        ] = _coerce_enum(SearchSortTypeEnum, config.SORT_TYPE, SearchSortTypeEnum.GENERAL),
        ...
        list_filter_condition: Annotated[
            str,
            typer.Option(
                "--list-filter-condition",
                help="Optional AI filtering condition applied on search list before fetching note details",
                rich_help_panel="Basic Configuration",
            ),
        ] = config.LIST_FILTER_CONDITION,
    ) -> SimpleNamespace:
        """MediaCrawler 命令行入口"""
        ...
        return SimpleNamespace(
            ...
            list_filter_condition=config.LIST_FILTER_CONDITION,
        )
